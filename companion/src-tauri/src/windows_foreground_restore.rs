...
use crate::target::{
    ForegroundRestoreOutcome, ForegroundTargetRestorer, Target, process_paths_match,
};
...
fn matching_windows(
    ...
    use windows_sys::Win32::UI::WindowsAndMessaging::{
        EnumWindows, GW_OWNER, GWL_EXSTYLE, GetWindow, GetWindowLongPtrW, GetWindowThreadProcessId,
...
#[cfg(test)]
mod tests {
    use super::{RestoreWindowHint, is_restore_candidate};
